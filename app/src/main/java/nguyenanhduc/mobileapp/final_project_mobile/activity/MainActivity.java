...
import nguyenanhduc.mobileapp.final_project_mobile.config.EditTextModel;
import nguyenanhduc.mobileapp.final_project_mobile.adapter.NamesAdapter;
...
public class MainActivity extends AppCompatActivity {
    ImageView playButton,logo,animationView,leaderboardButton;
